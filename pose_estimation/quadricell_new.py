...
def adaptive_ellipses_perimeters(a, b, c, total_rings, square_approximation_side):
    # Adaptive ring density based on ellipsoid curvature
    curvature_factor = torch.sqrt((b * c) / (a * b + a * c + b * c))
    ...
    # Adjust minor axis scaling based on adaptive density
...
def compute_quadricell_centers(
    ...
    (
        ...
        _,
        minor_axis_scaled,
    ) = adaptive_ellipses_perimeters(a, b, c, total_rings, square_approximation_side)
